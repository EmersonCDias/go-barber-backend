...
var AppointmentsRepositoryMOCK = /** @class */ (function () {
    function AppointmentsRepositoryMOCK() {
        this.appointments = [];
    }
    AppointmentsRepositoryMOCK.prototype.createAndSave = function (_a) {
    ...
    AppointmentsRepositoryMOCK.prototype.findAllInDayFromProvider = function (_a) {
        var provider_id = _a.provider_id, day = _a.day, month = _a.month, year = _a.year;
        return __awaiter(this, void 0, void 0, function () {
            var appointments;
            return __generator(this, function (_b) {
                appointments = this.appointments.filter(function (item) {
                    return item.provider_id === provider_id &&
                        date_fns_1.getDate(item.date) === day &&
                        date_fns_1.getMonth(item.date) + 1 === month &&
                        date_fns_1.getYear(item.date) === year;
                });
                return [2 /*return*/, appointments];
            });
        });
    };
    AppointmentsRepositoryMOCK.prototype.findAllInMonthFromProvider = function (_a) {
    ...
    AppointmentsRepositoryMOCK.prototype.findByDate = function (_a) {
    ...
    return AppointmentsRepositoryMOCK;
}());
exports.default = AppointmentsRepositoryMOCK;
