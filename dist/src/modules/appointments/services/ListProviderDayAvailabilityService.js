...
var ListProviderDayAvailabilityService = /** @class */ (function () {
    ...
    ListProviderDayAvailabilityService.prototype.run = function (_a) {
        var provider_id = _a.provider_id, day = _a.day, month = _a.month, year = _a.year;
        return __awaiter(this, void 0, void 0, function () {
            var appointments, hourStart, eachHourArray, currentDate, availableHours;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        availableHours = eachHourArray.map(function (hour) {
