...
var ListProviderMonthAvailabilityService = /** @class */ (function () {
    ...
    ListProviderMonthAvailabilityService.prototype.run = function (_a) {
        var provider_id = _a.provider_id, month = _a.month, year = _a.year;
        return __awaiter(this, void 0, void 0, function () {
            var appointments, numberOfDaysInMonth, eachDayArray, availableDays;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        availableDays = eachDayArray.map(function (day) {
                            var compareDate = new Date(year, month - 1, day, 23, 59, 59);
                            var appointmentsFoundByDay = appointments.filter(function (appointment) {
