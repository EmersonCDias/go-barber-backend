...
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.run = function (_a) {
        var provider_id = _a.provider_id, date = _a.date, user_id = _a.user_id;
        return __awaiter(this, void 0, void 0, function () {
            var appointmentDate, findAppointmentInSameDate, appointment, dateFormatter;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        appointmentDate = date_fns_1.startOfHour(date);
                        if (provider_id === user_id) {
                            throw new AppErrors_1.default('You can not create an appointment with yourself!');
                        }
                        if (date_fns_1.isBefore(appointmentDate, Date.now())) {
                            throw new AppErrors_1.default('You can not create a new appointment on a past date!');
                        }
                        if (date_fns_1.getHours(appointmentDate) < 8 || date_fns_1.getHours(appointmentDate) > 17) {
                            throw new AppErrors_1.default('You can only make an appointment between 8h and 17h');
                        }
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.appointmentsRepository.createAndSave({
                                provider_id: provider_id,
                                user_id: user_id,
                                date: appointmentDate,
                            })];
                    case 2:
                        appointment = _b.sent();
                        dateFormatter = date_fns_1.format(appointmentDate, "dd-MM-yyyy 'às' HH");
