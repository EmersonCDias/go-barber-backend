...
var listProviderDayAvailabilityService = new ProviderDayAvailabilityController_1.default();
var listProviderMonthAvailabilityService = new ProviderMonthAvailabilityController_1.default();
...
providersRouter.get('/:provider_id/day-availability', celebrate_1.celebrate((_a = {},
    ...
    _a)), listProviderDayAvailabilityService.index);
providersRouter.get('/:provider_id/month-availability', celebrate_1.celebrate((_b = {},
    _b[celebrate_1.Segments.PARAMS] = {
        provider_id: celebrate_1.Joi.string().uuid().required(),
    },
    _b)), listProviderMonthAvailabilityService.index);
