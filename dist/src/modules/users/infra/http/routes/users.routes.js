...
var uploadAvatar = multer_1.default(upload_1.default.multer);
...
usersRouter.patch('/avatar', ensureAuthenticated_1.default, uploadAvatar.single('avatar'), userAvatarController.update);
