    ...
    SendForgotPasswordEmailService.prototype.run = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.userTokensRepository.findUserByToken(token)];
                    case 1:
                        userToken = _c.sent();
                        if (!userToken)
                            throw new AppErrors_1.default('Token is missing');
                        return [4 /*yield*/, this.usersRepository.findUserById(userToken.user_id)];
                    case 2:
                        user = _c.sent();
                        if (!user)
                            throw new AppErrors_1.default('User does not exists');
                        tokenCreatedAt = userToken.created_at;
                        if (date_fns_1.differenceInHours(Date.now(), tokenCreatedAt) > 2) {
                            throw new AppErrors_1.default('Token expired');
                        }
                        _b = user;
