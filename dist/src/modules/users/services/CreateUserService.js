...
var CreateUserService = /** @class */ (function () {
    ...
    CreateUserService.prototype.run = function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (checkUserExists)
                            throw new AppErrors_1.default('E-mail address already exists');
                        return [4 /*yield*/, this.hashProvider.generateHash(password)];
                    case 2:
                        hashedPassword = _b.sent();
                        return [4 /*yield*/, this.usersRepository.createAndSaveUser({
                                name: name,
                                email: email,
