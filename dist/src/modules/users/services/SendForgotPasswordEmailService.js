...
var SendForgotPasswordEmailService = /** @class */ (function () {
    ...
    SendForgotPasswordEmailService.prototype.run = function (_a) {
        var email = _a.email;
        return __awaiter(this, void 0, void 0, function () {
            var user, token, forgotPasswordTemplate;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.findUserByEmail(email)];
                    case 1:
                        user = _b.sent();
                        if (!user) {
    ...
    SendForgotPasswordEmailService = __decorate([
        ...
        __metadata("design:paramtypes", [Object, MailProviderMOCK_1.default, Object])
