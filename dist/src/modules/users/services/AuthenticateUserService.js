...
var AuthenticateService = /** @class */ (function () {
    function AuthenticateService(usersRepository, hashProvider) {
        this.usersRepository = usersRepository;
        this.hashProvider = hashProvider;
    }
    AuthenticateService.prototype.run = function (_a) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new AppErrors_1.default('Incorrect e-mail/password combination', 401);
                        }
