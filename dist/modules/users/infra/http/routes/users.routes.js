...
const uploadAvatar = (0, _multer.default)(_upload.default.multer);
...
usersRouter.patch('/avatar', _ensureAuthenticated.default, uploadAvatar.single('avatar'), userAvatarController.update);
