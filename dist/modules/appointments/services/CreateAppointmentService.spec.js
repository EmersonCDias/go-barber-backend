...
var _NotificationRepositoryMOCK = _interopRequireDefault(require("../../notifications/repositories/mock/NotificationRepositoryMOCK"));
...
describe('CreateAppointmentService', () => {
  beforeEach(() => {
    ...
    notificationsRepositoryMOCK = new _NotificationRepositoryMOCK.default();
    appointmentsRepositoryMOCK = new _AppointmentsRepositoryMOCK.default();
    createAppointmentService = new _CreateAppointmentService.default(appointmentsRepositoryMOCK, notificationsRepositoryMOCK, cacheProviderMOCK);
  });
  ...
  it('should not be able to create two or more appointments on the same date', async () => {
    ...
    await expect(createAppointmentService.run({
      date,
      user_id: 'user_id',
      provider_id: 'provider_id'
